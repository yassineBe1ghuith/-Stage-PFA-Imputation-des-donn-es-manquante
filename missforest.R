...
#imputation des valeurs totaux avec missForest :


df_tot = missForest(df_tot, ntree = 40)
df_tot_imp = df_tot$ximp
  
for( i in 1:3548){
    df_tot_imp$b13[i] =  trunc(df_tot_imp$b13[i])
    df_tot_imp$b16[i] =  trunc(df_tot_imp$b16[i])
    df_tot_imp$b23[i] =  trunc(df_tot_imp$b23[i])
    df_tot_imp$b33[i] =  trunc(df_tot_imp$b33[i])
    df_tot_imp$b36[i] =  trunc(df_tot_imp$b36[i])
    df_tot_imp$c13[i] =  trunc(df_tot_imp$c13[i])
...
df_imp_finale = missForest(df ,ntree = 30) 

df = df_imp_finale$ximp
